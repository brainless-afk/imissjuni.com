...
import { selectNextImage } from "../common/imageUtils";
...
export default function StreamLayout(props: IStreamBoxProps) {
  ...
  const [usedImageSet, setUsedImageSet] = useState(props.usedImageSet);

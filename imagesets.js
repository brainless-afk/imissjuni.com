...
export const ERROR_IMAGE_SET = importAll(
    require.context('./public/imagesets/errored', false, /\.(png|jpe?g|svg|gif|mp4|webm)$/, 'lazy-once'),
    'imagesets/errored/'
);

export const HAVE_STREAM_IMAGE_SET = importAll(
    require.context('./public/imagesets/have-stream', false, /\.(png|jpe?g|svg|gif|mp4|webm)$/, 'lazy-once'),
    'imagesets/have-stream/'
);

export const NO_STREAM_IMAGE_SET = importAll(
    require.context('./public/imagesets/no-stream', false, /\.(png|jpe?g|svg|gif|mp4|webm)$/, 'lazy-once'),
    'imagesets/no-stream/'
);

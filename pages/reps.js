...
function VodInfo(props) {
  ...
  const caption = lang.formatString(
    lang.Reps.VodInfoUploadDate,
    useDictionary().FormatDateShort(date)
  );
    ...
    <LangContext.Provider value={lang}>
      <div className={styles.site}>
        ...
        <Head>
          ...
          <meta
            content={lang.Reps.SMMetaDescription}
            property="og:description"
          />
        </Head>
        <div
          className={`${styles.site} ${styles.repsPage} ${
            isValidating ? styles.isReloading : ""
          }`}
        >
          ...
          {data.error ? (
            <div className={`${styles.streamInfo} ${styles.streamInfoError}`}>
              <p>
                {lang.formatString(
                  lang.Reps.ErrorDescription,
                  lang.Reps.ErrorCodes[data.error]
                )}
              </p>
            </div>
          ) : (
          ...
          <p>
            <Link href="/">{lang.Reps.BackToStreamTrackerButton}</Link>
          </p>
